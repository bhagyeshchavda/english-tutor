...
if audio_info:
    try:
        ...
        # STEP 4: Advanced TTS with Speed Control (Moved before rerun for immediate playback)
        ...
        st.audio(audio_fp, format="audio/mp3", autoplay=True, sample_rate=22050)
        ...
        # Auto-scroll to bottom (After TTS to avoid interrupting playback)
        st.rerun()
...
<div style='text-align: center; color: #7f8c8d;'>
    💡 **Pro Tip**: Speak freely – the AI covers EVERY aspect of English in one seamless flow!
